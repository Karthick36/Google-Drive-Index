...
function render_search_result_list() {
	...
	<form class="d-flex mt-2" method="get" action="/${window.current_drive_order}:search" id="tm-search-form">
		<div class="input-group" style="position:relative;">
			...
			<span id="tm-search-clear" onclick="document.getElementById('tm-search-input').value=''; document.getElementById('tm-search-input').focus(); document.getElementById('tm-search-clear').style.display='none';" style="display:${model.q ? 'flex' : 'none'}; position:absolute; right:52px; top:50%; transform:translateY(-50%); z-index:10; cursor:pointer; align-items:center; justify-content:center; width:20px; height:20px; border-radius:50%; background:rgba(0,0,0,0.18); color:#fff; font-size:12px; line-height:1;">&#x2715;</span>
