...
function render_search_result_list() {
	...
	<form class="d-flex mt-2" method="get" action="/${window.current_drive_order}:search">
		<div class="input-group">
			<input class="form-control" name="q" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="Search Movies here" aria-label="Search" value="${model.q}" style="border-right:0; background:#fff !important; color:#111 !important; -webkit-user-select:text !important; user-select:text !important; pointer-events:auto !important;" required>
